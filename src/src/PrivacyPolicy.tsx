            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed mb-8">
                  This Privacy Policy explains how Trawise ("we", "our", or "us")
                  collects, uses, stores, and shares personal information when you
                  use our mobile application ("Service"). By using the Service,
                ...
                <div className="space-y-8">
                  <section>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                      We may collect various types of information depending on how
                      you interact with the Service:
                    </p>
                    <ul className="list-disc list-inside text-gray-700 space-y-2">
                      <li>
                        <strong>Account Information:</strong> Email address, name
                        (optional), and other profile data you provide
                      </li>
                      <li>
                        <strong>Location Data:</strong> Device GPS or approximate
                      ...
                      <li>
                        <strong>Authentication:</strong> Secure login credentials
                        or tokens
                      </li>
                      <li>
                  ...
                  <section>
                    ...
                    <ul className="list-disc list-inside text-gray-700 space-y-2">
                      ...
                      <li>
                        Prevent abuse, enforce terms, and comply with regulations
                      </li>
                    </ul>
                  </section>
                  ...
                  <section>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                      Depending on your region, our processing of your data may be
                      based on:
                    </p>
                    <ul className="list-disc list-inside text-gray-700 space-y-2">
                      ...
                      <li>
                        Legitimate business interests, such as product improvement
                        or fraud prevention
                      </li>
                    </ul>
                  </section>
                  ...
                  <section>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                      ...
                      as necessary to operate the Service. This includes:
                    </p>
                    <ul className="list-disc list-inside text-gray-700 space-y-2">
                  ...
                  <section>
                    ...
                    <p className="text-gray-700 leading-relaxed mt-4">
                      ...
                      <a
                        ...
                        className="text-blue-600 hover:text-blue-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 rounded underline decoration-transparent hover:decoration-current focus:decoration-current"
                      >
                        {SITE_CONFIG.email}
                      </a>{" "}
                  ...
                  <section>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      safeguards to protect your data. While we aim to ensure
                      security, no method of transmission or storage is fully
                      secure.
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      your own. Where required, we implement safeguards to ensure
