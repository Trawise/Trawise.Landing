            ...
            <address className="space-y-4 not-italic">
              <div className="flex items-center gap-3 text-gray-600">
                ...
                <a
                  ...
                  className="text-gray-600 hover:text-gray-900 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 rounded underline decoration-transparent hover:decoration-current focus:decoration-current"
                >
                  {SITE_CONFIG.email}
                </a>
              </div>
